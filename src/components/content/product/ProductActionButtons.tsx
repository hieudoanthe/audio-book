...
export default function ProductActionButtons({
  ...
  return (
    <div className="space-y-3">
      ...
      <button className="w-full px-6 py-3 rounded-lg bg-[#f68c2e] hover:bg-[#d77a1f] text-white font-semibold transition-colors flex items-center justify-center gap-2">
        <span>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
