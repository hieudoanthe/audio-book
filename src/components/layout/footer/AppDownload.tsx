...
export default function AppDownload() {
  return (
    <div className="space-y-4">
      <div className="font-bold text-base">TẢI ỨNG DỤNG</div>
      <div className="space-y-3">
        {/* App Store Button */}
        <button className="w-full bg-white rounded-lg px-4 py-3 flex items-center gap-3 hover:bg-zinc-100 transition-colors">
        ...
        <button className="w-full bg-white rounded-lg px-4 py-3 flex items-center gap-3 hover:bg-zinc-100 transition-colors">
          ...
          <div className="text-left flex-1">
            <div className="text-xs text-gray-600">GET IN ON</div>
