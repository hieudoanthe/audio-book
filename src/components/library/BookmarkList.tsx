...
export default function BookmarkList() {
  ...
  const handleItemClick = (item: (typeof bookmarks)[0]) => {
    ...
    return (
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h2 className="text-2xl font-bold text-white">Đánh dấu</h2>
        </div>
        <div className="text-center py-12">
          <p className="text-[#abafbb] text-lg">
            Chưa có nội dung đánh dấu nào
          </p>
        </div>
      </div>
    );
