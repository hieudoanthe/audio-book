...
export default function FavoriteList() {
  ...
  const handleItemClick = (item: (typeof favorites)[0]) => {
  ...
  if (favorites.length === 0) {
    return (
      <div className="text-center py-12">
        <p className="text-[#abafbb] text-lg">Chưa có nội dung yêu thích nào</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold text-white">Thích</h2>
        <button
